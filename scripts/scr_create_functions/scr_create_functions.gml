...
function scr_create_enemy(_x, _y, index){
	...
	Inst.max_attack_buffer = global.enemies[index].max_attack_buffer //Set the max attack buffer
	Inst.attack_type = global.enemies[index].attack_type //Set the attack type
	Inst.move_type = global.enemies[index].move_type //Set the move type
	Inst.target_team = global.enemies[index].target_team //Set the target team
	Inst.target_type = global.enemies[index].target_type //Set the target type
	...
	Inst.friend_emote = global.enemies[index].friend_emote //Set the friendly emote
	Inst.norm_emote = global.enemies[index].norm_emote //Set the neutral emote
